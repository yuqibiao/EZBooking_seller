...
public class ExplosionField extends View{
    ...
    private OnExplosionFinishedListener mOnExplosionFinishedListener;
    ...
    public void explode(final View view) {
        ...
        //防止重复点击
        if(explosionAnimatorsMap.get(view)!=null&&explosionAnimatorsMap.get(view).isRunning()){
            return;
        }
    ...
    private void explode(final View view,Rect rect) {
        final ExplosionAnimator animator = new ExplosionAnimator(
                this, Utils.createBitmapFromView(view), rect,mParticleFactory);
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                //---缩小,透明动画
                ObjectAnimator animator1 =  ObjectAnimator.ofFloat(view , "alpha" , 1f , 0f).setDuration(150);
                ObjectAnimator animator2 = ObjectAnimator.ofFloat(view , "scaleX" , 1f , 0f).setDuration(150);
                ObjectAnimator animator3=ObjectAnimator.ofFloat(view , "scaleY" , 1f , 0f).setDuration(150);
            ...
            public void onAnimationEnd(Animator animation) {
                //---放大透明动画
                ObjectAnimator animator1 =  ObjectAnimator.ofFloat(view , "alpha" , 0f , 1f).setDuration(150);
                ObjectAnimator animator2 = ObjectAnimator.ofFloat(view , "scaleX" , 0f , 1f).setDuration(150);
                ObjectAnimator animator3=ObjectAnimator.ofFloat(view , "scaleY" , 0f , 1f).setDuration(150);
                AnimatorSet animatorSet = new AnimatorSet();
                animatorSet.playTogether(animator1 , animator2 , animator3);
                animatorSet.start();
                explosionAnimators.remove(animation);
                explosionAnimatorsMap.remove(view);
                if(mOnExplosionFinishedListener!=null){
                    mOnExplosionFinishedListener.onExplosionFinished();
                }
            }
        });
        animator.start();
    ...
    public void setOnExplosionFinishedListener(OnExplosionFinishedListener onExplosionFinishedListener){
        this.mOnExplosionFinishedListener = onExplosionFinishedListener;
    }
    ...
    public interface OnExplosionFinishedListener{
